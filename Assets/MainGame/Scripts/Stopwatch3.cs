...
public class Stopwatch3 : MonoBehaviour
{
    ...
    public void GetName()
    {
        ...
        playerlabel.text = string.Format("{0} turns to speak!", playername3.text);
        playerlabel1.text = string.Format("{0} turns to speak!", playername3.text);
        playerlabel2.text = string.Format("{0} turns to speak!", playername3.text);
        playerlabel3.text = string.Format("{0} turns to speak!", playername3.text);
    ...
    public void StartStopwatch()
    {
        ...
        playerlabel.text = string.Format("{0} Get ready for Final Round!", playername.text);
        playerlabel1.text = string.Format("{0} Get ready for Final Round!", playername1.text);
        playerlabel2.text = string.Format("{0} Get ready for Final Round!", playername2.text);
        playerlabel3.text = string.Format("{0} Get ready for Final Round!", playername3.text);
    ...
    IEnumerator LateCall()
    {
        ...
        Yes.SetActive(true);
        No.SetActive(true);
        playerlabel.text = string.Format("{0} is that sentance is correct?", playername3.text);
