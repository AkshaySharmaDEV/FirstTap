...
public class Stopwatch2 : MonoBehaviour
{
    ...
    public void GetName()
    {
        ...
        playerlabel.text = string.Format("{0} turns to speak!", playername2.text);
        playerlabel1.text = string.Format("{0} turns to speak!", playername2.text);
        playerlabel2.text = string.Format("{0} turns to speak!", playername2.text);
        playerlabel3.text = string.Format("{0} turns to speak!", playername2.text);
    ...
    public void StartStopwatch()
    {
        ...
        playerlabel.text = string.Format("{0} Get ready for Round3!", playername.text);
        playerlabel1.text = string.Format("{0} Get ready for Round3!", playername1.text);
        playerlabel2.text = string.Format("{0} Get ready for Round3!", playername2.text);
        playerlabel3.text = string.Format("{0} Get ready for Round3!", playername3.text);
    ...
    IEnumerator LateCall()
    {
        ...
        Yes.SetActive(true);
        No.SetActive(true);
        playerlabel.text = string.Format("{0} is that sentance is correct?", playername2.text);
